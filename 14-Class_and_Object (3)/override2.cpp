...
class DerivedClass : public BaseClass {
    public:
        ...
        // }
/* Compiler Error Log:
* override2.cpp:26:21: error: 'virtual int DerivedClass::DoSomething(int&)' marked 'override', but does not override
   26 |         virtual int DoSomething(int& val) override { // override specifier to explicitly push the compiler to check for overriding
*/

        virtual int DoSomething(int& val) { // override specifier to explicitly push the compiler to check for overriding
            cout << "DerivedClass::DoSomething(" << val << ")" << endl;
            return val;
        }
